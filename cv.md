...
<div id="form-alani" class="form-alani">
  ...
  <p>Kişisel verilerin güvenliği ve iletişim takibi için lütfen formu doldurunuz. İndirme bağlantısı gönderim sonrası açılacaktır.</p>

  <form action="https://api.sheetmonkey.io/form/BURAYA_SHEETMONKEY_LINKINI_YAPISTIR" method="POST" style="max-width: 400px;">
...
<script>
  function prepareDownload(lang) {
    ...
    // 1. Dosya linkini dile göre güncelle
    if (lang === 'tr') {
    ...
    // 2. Form alanına yumuşak bir şekilde kaydır
